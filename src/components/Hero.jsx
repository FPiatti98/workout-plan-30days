    ...
    return(
        <>
            ...
            <ol className="benefits-list">
                ...
                <li>Become a lifetime gym enjoyer</li>
            </ol>
            <h3>The Rules</h3>
            <p>To complete this program, you <b>MUST</b> follow this simple rules:</p>
            ...
            <p>This training plan uses a structure known as the <b>BroSplit</b>, and follows this rotation </p>
